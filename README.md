...
## Creating a sequence diagram of how a note is added to the database: exercise 0.4
```mermaid
sequenceDiagram
    participant browser
    participant server
...
## Creating a sequence diagram of what happens when a user visits the single page app: exercise 0.5
```mermaid
sequenceDiagram
    participant browser
    participant server
